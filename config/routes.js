...
module.exports.routes = {
  ...
  'GET /leaderboard': { action: 'dashboard/view-leaderboard' },
  'GET /userdetails/:userId': { action: 'dashboard/view-userdetails' },
  ...
  // Client-side info
  'GET /api/v1/leaderboard': 'ClientinfoController.leaderboard',
